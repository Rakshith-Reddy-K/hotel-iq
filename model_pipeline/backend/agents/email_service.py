...
# Handles sending booking confirmation emails via SMTP.
# """
...
# SENDER_NAME = os.getenv("SENDER_NAME", "HotelIQ Booking")
...
#         logger.info("Booking confirmation email sent", booking_id=booking_id, email=guest_info.email)
#         return True
...
SENDER_EMAIL = os.getenv("SMTP_FROM_EMAIL") or os.getenv("SENDER_EMAIL") or SMTP_USERNAME
SENDER_NAME = os.getenv("SENDER_NAME", "HotelIQ Booking")
